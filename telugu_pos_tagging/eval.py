...
def train(dataset, model, args):
    ...
    print("avg acc: ", sum(accuracy_list)/len(accuracy_list), "avg recall: ", sum(recall_list)/len(recall_list),
...
dataset = torch.load("telugu_train.pt")
model = torch.load("telugu_model.pt")
model.to(device)
val_dataset = torch.load("telugu_val.pt")
test_dataset = torch.load("telugu_test.pt")
